...
router.post('/',             requireAuth, createComment)           // POST: Create comment.
router.patch('/:commentId',  requireAuth, editComment)             // PATCH: Edit comment.
router.delete('/:commentId', requireAuth, deleteComment)           // DELETE: Delete comment.
